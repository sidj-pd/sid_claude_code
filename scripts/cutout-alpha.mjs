...
const OVERRIDES = {
	...
	// layout goes to pieces.
	'bank-employee': {trim: true},
	'bank-grille': {trim: true},
	'token-display': {trim: true},
	'file-tower': {trim: true},
	'ledger-open': {trim: true},
	'form-pile': {trim: true},
	'rubber-stamp': {trim: true},
	'passbook-stack': {trim: true},
	'note-counter': {trim: true},
	'queue-post': {trim: true},
	'steel-almirah': {trim: true},
	'notice-board': {trim: true},
	'chai-glass': {trim: true},
